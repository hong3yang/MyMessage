...
public class LoveLikeLayout extends RelativeLayout
{
    ...
    private void init()
    {
        ...
        Drawable one = getResources().getDrawable(R.mipmap.ic_live_like_01);
        Drawable two = getResources().getDrawable(R.mipmap.ic_live_like_02);
        Drawable three = getResources().getDrawable(R.mipmap.ic_live_like_03);
        Drawable four = getResources().getDrawable(R.mipmap.ic_live_like_04);
        Drawable five = getResources().getDrawable(R.mipmap.ic_live_like_05);
        drawables[0] = one;
        drawables[1] = two;
        drawables[2] = three;
        drawables[3] = four;
